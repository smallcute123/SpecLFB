...
// DOC include start: BOOM Parameters
  ...
  enableFastPNR: Boolean = true,//开启快速PNR模式
  ...
  enableROBtracePrintf: Boolean =false,
  enableDispatchtracePrintf:Boolean =false,
  enableSpeculativeCause:Boolean = false,
  brmaskPrintf:Boolean =false,
  enableUnsafetracePrintf:Boolean =true,
  enableSpeclfb:Boolean =false
...
trait HasBoomCoreParameters extends freechips.rocketchip.tile.HasCoreParameters
{
  ...
  val ROBTRACE_PRINTF     = boomParams.enableROBtracePrintf//dump trace of ROB
  val DISTRACE_PRINTF     = boomParams.enableDispatchtracePrintf//dump trace of dispatching instruction to ROB
  val SPECULATIVE_TRACE   = boomParams.enableSpeculativeCause//dump trace of speculative load
  val brMask_PRINTF      =  boomParams.brmaskPrintf
  val UNSAFE_TRACE        = boomParams.enableUnsafetracePrintf  
  val SPECLFB             = boomParams.enableSpeclfb
  //************************************
